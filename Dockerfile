...
RUN apt-get -qqqy install software-properties-common dctrl-tools
RUN apt-get -qqqy install bind9utils bind9-doc dnsutils
ARG DEB_VERSION=1:9.16.9-1+ubuntu20.04.1+isc+1
